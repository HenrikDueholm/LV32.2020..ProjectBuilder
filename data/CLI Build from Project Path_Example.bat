...
ECHO "Project=[Absolute or Relative Path to target project, project must exist]"
...
ECHO "PPLFolder=[Absolute Path to folder containing HDH.ProjectBuilder.lvlibp]" - OPTIONAL: if not provided the current folder is used
