...
"CLI Build from Project Path.bat" "C:\Current projects\WS\PPL\HDH.ProjectBuilder.lvlibp\CLI Build from Project Path.vi" "Project=C:\Current projects\WS\LV32.2020.HDH.Driver.DMM\DMM\DMM.lvproj"
