...
echo Argument 4 is the folder where reports are to be stored.
echo.
echo Now running 'CLI Build from Project Path.vi'...
"CLI Build from Project Path.bat" "C:\Current projects\WS\PPL\HDH.ProjectBuilder.lvlibp\CLI Build from Project Path.vi" "Project=C:\Current projects\WS\LV32.2020.HDH.Driver.DMM\DMM\DMM.lvproj" "quit" "Report=C:\Current projects\_Report\TestData" "BuilderName=Project Builder" "BuilderData=davs"
