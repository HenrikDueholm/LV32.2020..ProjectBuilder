...
"CLI Build from Project Path.bat" "C:\Current projects\WS\PPL\HDH.ProjectBuilder.lvlibp\CLI Build from Project Path.vi" "C:\Current projects\WS\LV32.2020..ProjectBuilder\Test\Test_Exe.lvproj" "quit"
